	...
	default:
		...
		case '/': // Prefix: "/orders"
			...
			if len(elem) == 0 {
				...
				case "GET":
					r.name = "GetOrders"
					r.summary = "Returns a list of orders"
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "DELETE":
						r.name = "DeleteOrder"
						r.summary = "Deletes an existing order"
					...
					case "GET":
						r.name = "GetOrder"
						r.summary = "Returns the details of a specific order"
					...
					case "PUT":
						r.name = "UpdateOrder"
						r.summary = "Replaces an existing order"
				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.pathPattern = "/orders/{order_id}/cancel"
								r.args = args
								r.count = 1
								return r, true
							default:
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							case "POST":
								r.name = "PayOrder"
								r.summary = "Processes payment for an order"
								r.operationID = "payOrder"
								r.pathPattern = "/orders/{order_id}/pay"
								r.args = args
								r.count = 1
								return r, true
							default:
